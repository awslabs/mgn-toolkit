...
1. Run the following sample code as an Administrator in PowerShell to download the ZIP file included in this package, extract and execute the toolkit.
    - Adjust the last line as needed with the desired parameters mentioned [here](#switches)
...
| Network interface and IP count | Checks the number of network interfaces attached and IPv4 count. | Get-NetworkInterfaceandIPCount | NA
